<template>
    <div class="home" v-if="isDataLoaded">
        <div class="min-w-full header pb-4 pt-4">
            <h1 class="text-3xl">Wallet checker</h1>

            <div class="pt-5 pb-5">
                To work with the zkSync/Starknet/Layerzero/Zora/Aptos/Linea checker, you need to add addresses to the addresses folder in the respective files.<br>
                To work with the EVM checker, rename .env.example to .env and fill in the MORALIS_API_KEY.
            </div>

            <div class="pt-5 pb-5">
                Для работы чекера zkSync/Starknet/Layerzero/Zora/Aptos/Linea нужно добавить адреса в папке addresses в соответствующие файлы.<br>
